...
export const Room = [
	{ /* The Nomad  --  Merchant */
		...
		isAvailable: function() {
			return Engine.activeModuleId === 'room' && $SM.get('stores.fur', true) > 0;
		},
		scenes: {
			'start': {
				text: [
	...
	{ /* Noises Outside  --  gain wood/fur */
		title: _('Noises'),
		isAvailable: function() {
			return Engine.activeModuleId === 'room' && $SM.get('stores.wood');
		},
		scenes: {
			'start': {
				text: [
	...
	{ /* The Beggar  --  trade fur for better good */
		title: _('The Beggar'),
		isAvailable: function() {
			return Engine.activeModuleId === 'room' && $SM.get('stores.fur');
		},
		scenes: {
			start: {
				text: [
	...
	{ /* The Scout  --  Map Merchant */
		title: _('The Scout'),
		isAvailable: function() {
			return Engine.activeModuleId === 'room' && $SM.get('features.location.world');
		},
		scenes: {
			'start': {
				text: [
	...
	{ /* The Sick Man */
		...
		isAvailable: function() {
			return Engine.activeModuleId === 'room' && $SM.get('stores.medicine', true) > 0;
		},
		scenes: {
			'start': {
				text: [
